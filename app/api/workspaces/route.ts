    ...
    include: {
      ...
      spaces: {
        ...
        include: {
          ...
          lists: {
            where: { deletedAt: null },
            select: { id: true, name: true, color: true, textColor: true, icon: true, folderId: true, order: true, archived: true, isPrivate: true, accessJson: true, visibleColumnsJson: true, columnWidthsJson: true },
          },
