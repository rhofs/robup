...
export const FOLDER_ICON_CHOICES = [
  ...
  // Second batch. Grouped roughly by what they are for — work, people, money, media, technical,
  // nature, health, travel, food, symbols — because the picker shows them in this order and a list
  // sorted by nothing is a list you scan twice.
  'check-circle', 'list-todo', 'kanban', 'workflow', 'git-branch', 'milestone', 'route', 'timer', 'hourglass',
  'repeat', 'user-plus', 'handshake', 'presentation', 'megaphone', 'speech', 'banknote', 'credit-card', 'receipt',
  'piggy-bank', 'percent', 'mic', 'radio', 'tv', 'image', 'pen-tool', 'brush', 'type',
  'scissors', 'clapperboard', 'disc', 'podcast', 'cpu', 'hard-drive', 'monitor', 'smartphone', 'bug',
  'binary', 'lock', 'unlock', 'link', 'qr-code', 'search', 'filter', 'cloud-rain', 'wind',
  'waves', 'mountain', 'flower', 'sprout', 'bird', 'fish', 'dog', 'cat', 'dumbbell',
  'activity', 'stethoscope', 'pill', 'brain', 'footprints', 'map-pin', 'tent', 'ship', 'train-front',
  'bus', 'fuel', 'luggage', 'apple', 'cake', 'wine', 'beer', 'soup', 'bolt',
  'infinity', 'asterisk', 'hash', 'at-sign', 'circle-dot', 'diamond', 'triangle', 'square', 'hexagon',
  'shapes', 'sticker', 'paperclip', 'pin', 'tag', 'folder-open', 'archive', 'trash', 'eye',
  'thumbs-up', 'swords', 'dice-5', 'ghost', 'orbit',
];
