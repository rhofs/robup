  ...
  if (editing) {
    return (
      <input
        ...
        className="block bg-neutral-950 border border-blue-500 rounded-lg px-2 py-1 text-[11px] text-app-strong focus:outline-none"
      />
    );
  }
  ...
  return (
    <div>
      ...
      >
        ...
        <span className="truncate flex-1" style={isActive ? activeGlowStyle() : undefined}>
          {doc.title || 'Untitled'}
        </span>
        {owner && (
          <span
