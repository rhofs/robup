...
// Mobile-only channel/DM picker — stands in for the desktop sidebar's ChatSidebar (hidden below
// md, same as Spaces/Lists' FolderTree), reusing that exact component unmodified rather than
// rebuilding channel/DM creation for mobile. ChatSidebar doesn't take an "onSelect" callback (it
// calls setActiveChannelId directly, same as on desktop), so this closes itself by watching that
// store field change instead.
export default function MobileChatSheet({ open, onClose, workspaceId }: Props) {
