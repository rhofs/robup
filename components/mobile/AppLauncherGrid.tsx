...
export default function AppLauncherGridContent({
  ...
  return (
    <div>
      {/* The workspace switcher that used to sit here is gone with the classic layout it belonged
          to. On this surface the header carries a real one — workspace mark, name and a chevron,
          right where the workspace is named — and a second copy two taps deeper inside a menu about
          going somewhere was the same control twice. */}
